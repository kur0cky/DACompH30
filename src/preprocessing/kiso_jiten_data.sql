...
SUM(CASE WHEN unknown IS NULL THEN 1 ELSE 0 END),
SUM(CASE WHEN len0 IS NULL THEN 1 ELSE 0 END),
SUM(CASE WHEN len1 IS NULL THEN 1 ELSE 0 END),
SUM(CASE WHEN cm_start_time IS NULL THEN 1 ELSE 0 END),
SUM(CASE WHEN len2 IS NULL THEN 1 ELSE 0 END),
SUM(CASE WHEN len3 IS NULL THEN 1 ELSE 0 END),
SUM(CASE WHEN len4 IS NULL THEN 1 ELSE 0 END),
